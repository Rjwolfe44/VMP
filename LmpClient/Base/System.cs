...
namespace LmpClient.Base
{
        ...
        where T : ISystem, new()
    {
        ...
        protected void SetupRoutine(RoutineDefinition routine)
        {
            if (routine == null)
            {
                LunaLog.LogError("[VMP]: Cannot set a null routine!");
                return;
            }
            ...
            {
                LunaLog.LogError($"[VMP]: Routine {routine.Name} already defined");
            }
        }
        ...
        protected void ChangeRoutineExecutionInterval(RoutineExecution execution, string routineName, int newIntervalInMs)
        {
            ...
            {
                LunaLog.LogError($"[VMP]: Routine {execution}/{routineName} not defined");
            }
