    ...
    public partial class VesselsWindow : Window<VesselsWindow>
    {
        ...
        public override void RemoveWindowLock()
        {
            if (IsWindowLocked)
            {
                ...
                InputLockManager.RemoveControlLock("VMP_VesselsWindowsLock");
            }
        }
        ...
        public override void CheckWindowLock()
        {
            if (Display)
            {
                ...
                {
                    InputLockManager.SetControlLock(LmpImguiInputLockMask.WindowMouseCapture, "VMP_VesselsWindowsLock");
                    IsWindowLocked = true;
                }
                if (!shouldLock && IsWindowLocked)
                    RemoveWindowLock();
