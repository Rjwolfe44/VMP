    ...
    public partial class SystemsWindow : Window<SystemsWindow>
    {
        ...
        public override void RemoveWindowLock()
        {
            if (IsWindowLocked)
            {
                ...
                InputLockManager.RemoveControlLock("VMP_SystemsWindowsLock");
            }
        }
        ...
        public override void CheckWindowLock()
        {
            if (Display)
            {
                ...
                {
                    InputLockManager.SetControlLock(LmpImguiInputLockMask.WindowMouseCapture, "VMP_SystemsWindowsLock");
                    IsWindowLocked = true;
                }
                if (!shouldLock && IsWindowLocked)
                    RemoveWindowLock();
