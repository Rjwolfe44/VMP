    ...
    public partial class StatusWindow : Window<StatusWindow>
    {
...
#if DEBUG
        private static readonly string Title = $"Vlad Multiplayer (PID: {CommonUtil.ProcessId})";
#else
        private static readonly string Title = "Vlad Multiplayer";
#endif
        ...
        public override void RemoveWindowLock()
        {
            if (IsWindowLocked)
            {
                ...
                InputLockManager.RemoveControlLock("VMP_PlayerStatusLock");
            }
        }
        ...
        public override void CheckWindowLock()
        {
            if (Display)
            {
                ...
                {
                    InputLockManager.SetControlLock(LmpImguiInputLockMask.WindowMouseCapture, "VMP_PlayerStatusLock");
                    IsWindowLocked = true;
                }
                if (!shouldLock && IsWindowLocked)
                    RemoveWindowLock();
        ...
        /// <summary>
        /// Screen-space rectangle of the VMP status panel, for docking other UI (e.g. log console).
        /// </summary>
