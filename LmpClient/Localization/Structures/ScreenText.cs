namespace LmpClient.Localization.Structures
{
    public class ScreenText
    {
        ...
        public string ImageSaved { get; set; } = "Image saved to GameData/VladMultiplayer/Screenshots";
        ...
        public string CannotLoadGames { get; set; } = "Vlad Multiplayer does not allow loading savegames";
