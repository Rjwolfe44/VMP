...
namespace LmpClient.Systems.SettingsSys
{
    public static class SettingsReadSaveHandler
    {
        ...
        private static string DataFolderPath => CommonUtil.CombinePaths(MainSystem.KspPath, "GameData", "VladMultiplayer", "Data");
        ...
        public static SettingStructure ReadSettings()
        {
            ...
            {
                LunaLog.Log("[VMP]: Backing up settings file!");
        ...
        private static void RestoreBackupIfNoSettings()
        {
            ...
            {
                LunaLog.Log("[VMP]: Restoring player settings file!");
