...
namespace LmpClient.Systems.Mod
{
    public class ModFileHandler : SubSystem<ModSystem>
    {
        ...
        public bool ParseModFile(ModControlStructure modFileData)
        {
            ...
            {
                LunaLog.LogError("[VMP]: Mod check failed!");
            ...
            LunaLog.Log("[VMP]: Mod check passed!");
            return true;
        }
        ...
        {
            var tempModFilePath = CommonUtil.CombinePaths(MainSystem.KspPath, "GameData", "VladMultiplayer", "Data", "KSPModControl.xml");
