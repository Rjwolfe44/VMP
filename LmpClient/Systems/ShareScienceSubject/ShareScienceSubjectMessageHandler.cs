...
namespace LmpClient.Systems.ShareScienceSubject
{
    public class ShareScienceSubjectMessageHandler : SubSystem<ShareScienceSubjectSystem>, IMessageHandler
    {
        ...
        public void HandleMessage(IServerMessageBase msg)
        {
            ...
            {
                LunaLog.LogWarning("[VMP] Ignoring legacy ScienceSubjectUpdate because persistent sync owns science subject convergence.");
                return;
            }
        ...
        public static ScienceSubject ConvertByteArrayToScienceSubject(byte[] data, int numBytes)
        {
            ...
            {
                LunaLog.LogError($"[VMP]: Error while deserializing science subject configNode: {e}");
                return null;
            }
