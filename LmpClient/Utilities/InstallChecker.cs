...
namespace LmpClient.Utilities
{
    public class InstallChecker
    {
        ...
        public static bool IsCorrectlyInstalled()
        {
            ...
            var shouldBeInstalledAt = CommonUtil.CombinePaths(kspPath, "GameData", "VladMultiplayer", "Plugins", "LmpClient.dll");
        ...
        public static void SpawnDialog()
        {
            ...
            LunaLog.Log($"[InstallChecker] VMP is currently installed on '{_currentPath}', should be installed at '{_correctPath}'");
