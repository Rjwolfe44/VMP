...
namespace LmpClient.VesselUtilities
{
    public class VesselSerializer
    {
        ...
        public static ProtoVessel DeserializeVessel(byte[] data, int numBytes)
        {
            ...
            {
                LunaLog.LogError($"[VMP]: Error while deserializing vessel: {e}");
                return null;
            }
        }
        ...
        public static ProtoVessel CreateSafeProtoVesselFromConfigNode(ConfigNode inputNode, Guid protoVesselId)
        {
            ...
            {
                LunaLog.LogError($"[VMP]: Damaged vessel {protoVesselId}, exception: {e}");
                return null;
            }
        }
        ...
        private static bool PreSerializationChecks(ProtoVessel protoVessel, out ConfigNode configNode)
        {
            ...
            if (protoVessel == null)
            {
                LunaLog.LogError("[VMP]: Cannot serialize a null protovessel");
                return false;
            }
            ...
            {
                LunaLog.LogError($"[VMP]: Error while saving vessel: {e}");
                return false;
            }
            ...
            {
                LunaLog.LogError($"[VMP]: Vessel {vesselId} has NaN position");
                return false;
            }
